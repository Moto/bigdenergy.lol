...
function aboutMe() {
	var aboutMeArray = ['>About:', 'Blah Blah Blah', 'Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah'];
	seperator();
...
function contactMe() {
	var contactArray = ['>Contact:', '[GitHub](https://github.com/Moto)', '[Email](edgedns@icloud.com)'];
	seperator();
